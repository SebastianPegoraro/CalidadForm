...
$accionesTramites = Accion::showOficinas();
    ...
    <div class='container'>
        <div class='row'>
            ...
            <div class='col-8 col-md-7'>
                <h4 class='titleHead regular'>Listado de Oficinas</h4>
            </div>
        </div>
    </div>
</header>
                            ...
                            foreach($accionesTramites as $contenido){
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><a href="verOficina.php?res=<?php echo $contenido['id_responsable'] ?>&jur=<?php echo $contenido['id_jurisdiccion'] ?>" class="btn btn-outline-primary"><i class="far fa-eye"></i></a></td>
                                    </tr>
                                </tbody>
                                <?php
                            }
